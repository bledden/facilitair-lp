// Send Test Blog Announcement Email
...
async function sendTestEmail() {
    console.log('Sending test email to blake@facilitair.ai...\n');

    try {
        const testEmail = 'blake@facilitair.ai';
        const testToken = 'test-unsubscribe-token';

        const { data, error } = await resend.emails.send({
            from: 'Blake @ FACILITAIR <blake@facilitair.ai>',
            to: testEmail,
            subject: '[TEST] First Blog Post: Building in Public - Weekly AI Research Updates',
            html: getBlogAnnouncementEmailHTML(testEmail, testToken)
        });
        ...
        console.log(`\nCheck your inbox at blake@facilitair.ai`);
    } catch (error) {
