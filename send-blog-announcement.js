// Send Blog Announcement Email to Confirmed Subscribers
// Usage: node send-blog-announcement.js
...
async function sendBlogAnnouncement() {
    console.log('Starting blog announcement email send...\n');
    ...
    if (subscribers.length === 0) {
        console.log('No confirmed subscribers to email.');
        db.close();
        return;
    }
...
// Run the script
sendBlogAnnouncement().catch(error => {
