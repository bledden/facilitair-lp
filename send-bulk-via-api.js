/**
 * Send apology emails to all confirmed subscribers
 * Fetches subscribers from API to avoid local database dependency
 */
...
async function sendBulkApologyEmails() {
    ...
    const response = await fetch('https://facilitair.ai/api/admin/subscribers', {
